...
- Preserve the natural act of journaling without turning writing into data entry
- Make moments of meaning explicit when they matter, and invisible when they do not
- Support long-term memory, reflection, and continuity across years
- Enable accurate retrieval and synthesis by future language models without requiring tagging or rigid schemas
- Serve as a foundation for a living persona that reflects values, voice, and growth rather than isolated facts
- Remain lightweight enough to be sustained daily
...
- Signal: Reflection is the default
- Most entries will use zero or one signal block
- Multiple signal blocks are allowed but should be rare
...
- If structure gets in the way, ignore it.
- If you forget context, keep writing.
- If a signal block feels forced, skip it.
...
- What patterns emerged around health when fatigue was present?
- How did thinking about relationships change over time?
